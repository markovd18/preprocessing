...
public class BasicPreprocessingExample {
    ...
    public static void wordsStatistics(List<String> lines, String tokenizeRegex, boolean stemm, Set<String> stopwords,
            boolean removeAccentsBeforeStemming, boolean removeAccentsAfterStemming, boolean toLowercase) {
        ...
        for (String line : lines) {
            ...
            for (String token : tokenize(line, tokenizeRegex)) {
                // for (String token : BasicTokenizer.tokenize(line,
                // BasicTokenizer.defaultRegex)) {
                if (stemm) {
